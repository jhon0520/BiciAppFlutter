...
import 'package:biciapp/src/view/historylaps/historylaps_view.dart';
import 'package:biciapp/src/global/switchappbarbuttom_global.dart';
import 'package:biciapp/src/global/wallpaper_global.dart';


class HistoryLapsPage extends StatelessWidget {
  const HistoryLapsPage({Key key}) : super(key: key);
